...
<title>File a Report &bull; Campus Lost &amp; Found Ledger</title>
  ...
  <div class="report-grid">
    <section>
      ...
      <div class="type-toggle">
        ...
        <div class="actions">
          <button type="submit">Submit entry &rarr;</button>
    ...
    <aside class="guidance">
      ...
      <ol>
        <li>You file the report &rarr; <b>visible only to admins</b> at first.</li>
